...
DEFAULT_GALAXY_BASE_URL = "https://api.galaxy.ai/api/v1/runs"
...
class GalaxyProvider(LLMProvider):
    ...
    def __init__(self):
        ...
        self.workflow_id = os.environ.get("VITE_GALAXY_WORKFLOW_ID")
        self.node_id = os.environ.get("VITE_GALAXY_NODE_ID")
